...
namespace CMT_Tracker
{
    ...
    class CMT_SURF
    {
        ...
        //private OpenSURFDetector mSURFDetector;
        ...
        //private OpenSurfMatcher<float> mAdaptiveOpenSurfBackgroundMatcher;
        //private OpenSurfMatcher<float> mOpenSurfObjectMatcher;  
        ...
        public void Reset()
        {
           ...
           //mSURFDetector = new OpenSURFDetector(25, false);
           ...
           // mOpenSurfObjectMatcher = new OpenSurfMatcher<float>();
           // mAdaptiveOpenSurfBackgroundMatcher = new OpenSurfMatcher<float>();
        ...
        private void Initialize(Image<Gray, Byte> frame, RectangleF ROI)
        {
            ...
            else
            {
               ...
               mSurfObjectMatcher = new BruteForceMatcher<float>(DistanceType.L2);
                ...
                //mOpenSurfObjectMatcher = new OpenSurfMatcher<float>();
               // mOpenSurfObjectMatcher.AddFeatures(mActiveFeatures);

               mAdaptiveSurfBackgroundMatcher = new BruteForceMatcher<float>(DistanceType.L2);
                mAdaptiveSurfBackgroundMatcher.Add(mInitialBackgroundFeatures);
               // mAdaptiveOpenSurfBackgroundMatcher = new OpenSurfMatcher<float>();
              // mAdaptiveOpenSurfBackgroundMatcher.AddFeatures(mInitialBackgroundFeatures);
        ...
        private Rectangle ProcessFrame(Image<Gray, Byte> frame, RectangleF ROI)
        {
            ...
            if (mSelectedKeypoints != null & mSelectedKeypoints.Count > 0)
            {
                ...
                SURFEstimate(tracked_keypoints, tracked_classes, ref centerEstimate, ref scaleEstimate, ref rotationEstimate);
                ...
                else
                {
                   ...
                   // mAdaptiveOpenSurfBackgroundMatcher = null;
                  //  mAdaptiveOpenSurfBackgroundMatcher = new OpenSurfMatcher<float>();
                  //  mAdaptiveOpenSurfBackgroundMatcher.AddFeatures(mAdaptiveBackgroundFeaturesPrevious);
                ...
                using (StreamWriter sw = File.AppendText(@"Debug2\keypoints.txt"))
                {
        ...
        private void FindPossibleBackgroundKeypoints()
        {
            ...
            {
                mAdaptiveOpenSurfBackgroundMatcher.getMatches(mCurrentFrameFeatures, mCurrentFrameKeypoints, bgnd_matches_all, bgnd_matches_all_distances);
            }*/
            if (mCurrentFrameKeypoints.Length > 0)
            {
                //sw7.Restart();
        ...
        private void MatchObjectFeatures()
        {
            ...
            /*if (mPossibleObjectFeatures != null && mPossibleObjectFeatures.Rows > 0)
            {
                mOpenSurfObjectMatcher.getMatches(mActiveFeatures, mActiveKeypoints, matches_all, matches_all_distances);
            }*/
        ...
        private void UpdateAdaptiveBackground()
        {
            ...
            if (mAdaptiveBackgroundKeypoints.Count > 0)
            {
               ...
               // mAdaptiveOpenSurfBackgroundMatcher = null;
              //  mAdaptiveOpenSurfBackgroundMatcher = new OpenSurfMatcher<float>();
              //  mAdaptiveOpenSurfBackgroundMatcher.AddFeatures(mAdaptiveBackgroundFeatures);
            }
        }
        #endregion
