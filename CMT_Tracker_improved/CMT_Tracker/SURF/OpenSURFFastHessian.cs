...
namespace OpenSURF
{
  public class OpenSURFFastHessian
  {
    ...
    /// <returns></returns>
    public static List<OpenSURFIPoint> getIpoints(float thresh, int octaves, int init_sample, OpenSURFIntegralImage img)
    {
      OpenSURFFastHessian fh = new OpenSURFFastHessian(thresh, octaves, init_sample, img);
    ...
    /// <param name="init_sample"></param>
    /// <param name="img"></param>
    public OpenSURFFastHessian(float thresh, int octaves, int init_sample, OpenSURFIntegralImage img)
    {
      this.thresh = thresh;
    ...
    private OpenSURFIntegralImage img;


    /// <summary>
    /// These get built
    /// </summary>
    private List<OpenSURFIPoint> ipts;
    ...
    /// </summary>
    public List<OpenSURFIPoint> getIpoints()
    {
      // filter index map
      int [,] filter_map = {{0,1,2,3}, {1,3,4,5}, {3,5,6,7}, {5,7,8,9}, {7,9,10,11}};

      // Clear the vector of exisiting ipts
      if (ipts == null) ipts = new List<OpenSURFIPoint>();
      else ipts.Clear();
    ...
    void buildResponseMap()
    {
        ...
        /*
        StreamWriter LogFile = new StreamWriter(@"fast_hessian_log.csv");
        StringBuilder StrBldr = new StringBuilder("w,step,b,l,inverse_area,");
        StrBldr.Append("dxx_b1_r1,dxx_b1_c1,dxx_b1_r2,dxx_b1_c2,");
        StrBldr.Append("dxx_b2_r1,dxx_b2_c1,dxx_b2_r2,dxx_b2_c2,");
        StrBldr.Append("dyy_b1_r1,dyy_b1_c1,dyy_b1_r2,dyy_b1_c2,");
        StrBldr.Append("dyy_b2_r1,dyy_b2_c1,dyy_b2_r2,dyy_b2_c2,");
        StrBldr.Append("dxy_b1_r1,dxy_b1_c1,dxy_b1_r2,dxy_b1_c2,");
        StrBldr.Append("dxy_b2_r1,dxy_b2_c1,dxy_b2_r2,dxy_b2_c2,");
        StrBldr.Append("dxy_b3_r1,dxy_b3_c1,dxy_b3_r2,dxy_b3_c2,");
        StrBldr.Append("dxy_b4_r1,dxy_b4_c1,dxy_b4_r2,dxy_b4_c2");
        LogFile.WriteLine(StrBldr.ToString());
        LogFile.Close();
        */
    ...
    /// </summary>
    /// <param name="rl"></param>
    unsafe private void buildResponseLayer(ResponseLayer rl)
    {
        ...
        //StreamWriter LogFile = new StreamWriter(@"fast_hessian_log.csv", true);

        float[,] IIMatrix = img.GetIIMatrix();

        fixed (float* ptrMatrix = IIMatrix)
        {
            for (int r, c, ar = 0, index = 0; ar < rl.height; ++ar)
            {
                for (int ac = 0; ac < rl.width; ++ac, index++)
                {
                    ...
                    Dxx = img.BoxIntegral(ptrMatrix, r - l + 1, c - b, 2 * l - 1, w)
                        - img.BoxIntegral(ptrMatrix, r - l + 1, c - l / 2, 2 * l - 1, l) * 3;
                    Dyy = img.BoxIntegral(ptrMatrix, r - b, c - l + 1, w, 2 * l - 1)
                        - img.BoxIntegral(ptrMatrix, r - l / 2, c - l + 1, l, 2 * l - 1) * 3;
                    /* Maashri: Bug: this won't affect the final outcome since Dxy is squared at the end
                     Dxy = +img.BoxIntegral(r - l, c + 1, l, l)
                          + img.BoxIntegral(r + 1, c - l, l, l)
                          - img.BoxIntegral(r - l, c - l, l, l)
                          - img.BoxIntegral(r + 1, c + 1, l, l);
                     */
                    Dxy = -img.BoxIntegral(ptrMatrix, r - l, c + 1, l, l)
                          - img.BoxIntegral(ptrMatrix, r + 1, c - l, l, l)
                          + img.BoxIntegral(ptrMatrix, r - l, c - l, l, l)
                          + img.BoxIntegral(ptrMatrix, r + 1, c + 1, l, l);
                    ...
                    // ---------------------------
                    // Logging access pattern
                    // ---------------------------
                    /*
                    StringBuilder StrBldr = new StringBuilder();
                    StrBldr.Append(w.ToString() + ",");
                    StrBldr.Append(step.ToString() + ",");
                    StrBldr.Append(b.ToString() + ",");
                    StrBldr.Append(l.ToString() + ",");
                    StrBldr.Append(inverse_area.ToString() + ",");

                    int dxx_b1_r1 = r - l + 1; StrBldr.Append(dxx_b1_r1.ToString() + ",");
                    int dxx_b1_c1 = c - b; StrBldr.Append(dxx_b1_c1.ToString() + ",");
                    int dxx_b1_r2 = dxx_b1_r1 + (2 * l - 1); StrBldr.Append(dxx_b1_r2.ToString() + ",");
                    int dxx_b1_c2 = dxx_b1_c1 + w; StrBldr.Append(dxx_b1_c2.ToString() + ",");

                    int dxx_b2_r1 = r - l + 1; StrBldr.Append(dxx_b2_r1.ToString() + ",");
                    int dxx_b2_c1 = c - l / 2; StrBldr.Append(dxx_b2_c1.ToString() + ",");
                    int dxx_b2_r2 = dxx_b2_r1 + (2 * l - 1); StrBldr.Append(dxx_b2_r2.ToString() + ",");
                    int dxx_b2_c2 = dxx_b2_c1 + l; StrBldr.Append(dxx_b2_c2.ToString() + ",");

                    int dyy_b1_r1 = r - b; StrBldr.Append(dyy_b1_r1.ToString() + ",");
                    int dyy_b1_c1 = c - l + 1; StrBldr.Append(dyy_b1_c1.ToString() + ",");
                    int dyy_b1_r2 = w; StrBldr.Append(dyy_b1_r2.ToString() + ",");
                    int dyy_b1_c2 = 2 * l - 1; StrBldr.Append(dyy_b1_c2.ToString() + ",");

                    int dyy_b2_r1 = r - l / 2; StrBldr.Append(dyy_b2_r1.ToString() + ",");
                    int dyy_b2_c1 = c - l + 1; StrBldr.Append(dyy_b2_c1.ToString() + ",");
                    int dyy_b2_r2 = dyy_b2_r1 + l; StrBldr.Append(dyy_b2_r2.ToString() + ",");
                    int dyy_b2_c2 = dyy_b2_c1 + (2 * l - 1); StrBldr.Append(dyy_b2_c2.ToString() + ",");

                    int dxy_b1_r1 = r - l; StrBldr.Append(dxy_b1_r1.ToString() + ",");
                    int dxy_b1_c1 = c + 1; StrBldr.Append(dxy_b1_c1.ToString() + ",");
                    int dxy_b1_r2 = dxy_b1_r1 + l; StrBldr.Append(dxy_b1_r2.ToString() + ",");
                    int dxy_b1_c2 = dxy_b1_c1 + l; StrBldr.Append(dxy_b1_c2.ToString() + ",");

                    int dxy_b2_r1 = r + 1; StrBldr.Append(dxy_b2_r1.ToString() + ",");
                    int dxy_b2_c1 = c - l; StrBldr.Append(dxy_b2_c1.ToString() + ",");
                    int dxy_b2_r2 = dxy_b2_r1 + l; StrBldr.Append(dxy_b2_r2.ToString() + ",");
                    int dxy_b2_c2 = dxy_b2_c1 + l; StrBldr.Append(dxy_b2_c2.ToString() + ",");

                    int dxy_b3_r1 = r - l; StrBldr.Append(dxy_b3_r1.ToString() + ",");
                    int dxy_b3_c1 = c - l; StrBldr.Append(dxy_b3_c1.ToString() + ",");
                    int dxy_b3_r2 = dxy_b3_r1 + l; StrBldr.Append(dxy_b3_r2.ToString() + ",");
                    int dxy_b3_c2 = dxy_b3_c1 + l; StrBldr.Append(dxy_b3_c2.ToString() + ",");

                    int dxy_b4_r1 = r + 1; StrBldr.Append(dxy_b4_r1.ToString() + ",");
                    int dxy_b4_c1 = c + 1; StrBldr.Append(dxy_b4_c1.ToString() + ",");
                    int dxy_b4_r2 = dxy_b4_r1 + l; StrBldr.Append(dxy_b4_r2.ToString() + ",");
                    int dxy_b4_c2 = dxy_b4_c1 + l; StrBldr.Append(dxy_b4_c2.ToString());
    ...
    void interpolateExtremum(int r, int c, ResponseLayer t, ResponseLayer m, ResponseLayer b)
    {
      ...
      {
        OpenSURFIPoint ipt = new OpenSURFIPoint();
        ...
        // Maashri: assigning original corrdinates and scale
        ipt.c = c;
        ipt.r = r;
        ipt.interval =
            (m.filter == 15) ? 2 :
